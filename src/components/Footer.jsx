    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-description">
              Soluciones digitales: webs profesionales, sistemas, CRMs,
              automatización e IA aplicada para negocios que quieren ordenar
              procesos y vender mejor.
            </p>
          </div>
          ...
          <div className="footer-cols">
            <div className="footer-col">
              ...
              <a className="footer-link" href="#tecnologias">
                Tecnologías
              </a>
            ...
            <div className="footer-col">
              ...
              <p className="footer-muted">Lunes a viernes, 9 a 18 hs.</p>
            </div>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <p className="footer-made">Hecho con foco en resultados.</p>
        </div>
      </div>
    </footer>
  );
